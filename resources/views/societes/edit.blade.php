...
<div>
    <div  class="border p-4 my-4">
        <fieldset class="border p-3">
            <legend>Modifier la société & son utilisateur principal</legend>
                                ...
                                <form method="POST" action="{{ route('societes.update', $societe->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="raison_sociale" class="form-control" value="{{ old('raison_sociale', $societe->raison_sociale) }}" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">ICE</label>
                                            <input type="text" name="ice" class="form-control" value="{{ old('ice', $societe->ice) }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Pays</label>
                                            <input type="text" name="pays" class="form-control" value="{{ old('pays', $societe->pays) }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Ville</label>
                                            <input type="text" name="ville" class="form-control" value="{{ old('ville', $societe->ville) }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Adresse</label>
                                            <input type="text" name="adresse" class="form-control" value="{{ old('adresse', $societe->adresse) }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if($societe->logo)
                                                <img src="{{ asset('storage/'.$societe->logo) }}" alt="Logo" class="mt-2" width="100">
                                            @endif
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="user_prenom" class="form-control" value="{{ old('user_prenom', $user?->prenom ?? '') }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                        ...
                                        @if($user?->photo)
                                                <img src="{{ asset('storage/'.$user->photo) }}" alt="Photo" class="mt-2" width="80">
                                            @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-check mt-4">
                                                <input class="form-check-input" type="checkbox" name="user_actif" id="user_actif" value="1" {{ old('user_actif', $user?->actif ?? false) ? 'checked' : '' }}>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-success">
                                            <i class="bi bi-building-add"></i> Mettre à jour
                                        </button>
                                    </div>
                                </form>
                            </div>
