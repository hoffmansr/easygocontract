...
<div>
    <div  class="border p-4 my-4">
        <fieldset class="border p-3">
            <legend>Modification de Role</legend>
                            ...
                            <form method="POST" action="{{ route('roles.update', $role->id) }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="name" class="form-control form-control-lg" 
                                        ...
                                        placeholder="Ex: Administrateur" required>
                                </div>
                                                ...
                                                <div class="card-header">
                                                    <div class="form-check">
                                                        <input class="form-check-input module-checkbox" type="checkbox" 
                                                            ...
                                                            {{-- coche si toutes les permissions du module sont déjà attribuées --}}
                                                            @if(count(array_intersect($permissions, $role->permissions->pluck('name')->toArray())) === count($permissions)) checked @endif>
                                                    ...
                                                    @foreach($permissions as $permission)
                                                        <div class="form-check">
                                                            <input class="form-check-input permission-checkbox" type="checkbox"
                                                                ...
                                                                {{-- coche si ce rôle a déjà cette permission --}}
                                ...
                                <div class="mt-4 text-end">
                                    <a href="{{ route('roles.index') }}" class="btn btn-secondary btn-lg me-2">
