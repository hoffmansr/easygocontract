...
<div>
    <div  class="border p-4 my-4">
        <fieldset class="border p-3">
            <legend>   <h4 class="mb-4">Créer un Clausier</h4></legend>
           <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        <div class="card-body px-0 pb-2">
                            ...
                            <div class="container">
                                ...
                                <form action="{{ route('clausiers.store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <!-- Langue -->
                                    ...
                                    <textarea name="contenu" id="contenu" class="form-control" rows="8">{{ old('contenu') }}</textarea>
